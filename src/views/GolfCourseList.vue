...
const courses = {
  ...
  santaponsa1: { name: 'GOLF SANTA PONSA 1', url: 'https://open.imaster.golf/es/santa-ponsa/disponibilidad', openInModal: true },
  ...
  sonmuntaner: { name: 'GOLF SON MUNTANER', url: 'https://arabella.golfmanager.com/consumer/ebookings?resource=&resourcetype=1', openInModal: false },
  sonservera: { name: 'CLUB GOLF SON SERVERA', url: 'https://open.imaster.golf/es/sonservera/disponibilidad', openInModal: true },
  sontermes: { name: 'GOLF DE SON TERMES', url: 'https://open.imaster.golf/en/son-termes/disponibilidad', openInModal: true },
  sonquint: { name: 'GOLF SON QUINT', url: 'https://arabella.golfmanager.com/consumer/ebookings?resource=&resourcetype=3', openInModal: false },
